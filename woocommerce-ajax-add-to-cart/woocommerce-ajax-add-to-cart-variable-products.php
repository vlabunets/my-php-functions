<?php
/*
Plugin Name: Woocommerce OPM add to cart via Ajax
...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	**/
	...
	function ajax_add_to_cart_script() {
	  wp_enqueue_script( 'add-to-cart-variation_ajax', plugins_url() . '/woocommerce-ajax-add-to-cart/js/add-to-cart-variation.js', array('jquery'), '', true );
	}
	...
	function woocommerce_add_to_cart_variable_rc_callback() {
        ...
        /**
        * woocommerce_add_to_cart via ajax cart refresh
        */
